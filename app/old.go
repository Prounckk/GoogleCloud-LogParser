...
//		bucket := e.Bucket
//
//		if strings.ContainsAny(file, "json") {
//			Reader(file, bucket)
//		}
//		return nil
//	}
...
//	}
//	if err = ftpClient.Upload(string(slurp), filename); err != nil {
...
//
//	//if err := client.Object(filename).Delete(ctx); err != nil {
//	//	fmt.Printf("deleteFiles: unable to delete file %s: %s", filename, err)
//	//}
//	rcc.Close()
//}
